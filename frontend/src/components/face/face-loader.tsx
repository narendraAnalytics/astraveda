...
const STEPS = [
  'Reading the shape of your face…',
  'Studying your forehead and brow…',
...
/** Rotating-lotus loader — teal sibling of the Palm/Kundali loaders. */
export function FaceLoader({ size = 200 }: { size?: number }) {
      ...
      <View style={{ width: size, height: size, alignItems: 'center', justifyContent: 'center' }}>
        <Animated.View style={[StyleSheet.absoluteFill, ringStyle]}>
          <Svg width={size} height={size}>
            ...
            <Circle cx={r} cy={r} r={r - 6} stroke="#b7e0d8" strokeWidth={1.5} fill="none" />
          </Svg>
        </Animated.View>
...
const styles = StyleSheet.create({
  ...
  om: { fontSize: 34, color: '#effbf8', lineHeight: 40 },
  statusWrap: { height: 26, marginTop: 22, justifyContent: 'center' },
  status: { fontSize: 13, fontWeight: '600', color: '#3f6f64', letterSpacing: 0.3 },
});
