  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 px-5 sm:px-9 py-4 sm:py-5">
      <a href="/" className="inline-flex items-center gap-2.5">
        <img src={LOGO_URL} alt="AstraVeda" className="h-8 w-8 object-contain" />
        <span className="font-[family-name:var(--font-display)] text-[17px] tracking-[.05em] font-semibold text-[#1B1730]">
          ASTRAVEDA
        </span>
      </a>
    </header>
