// Temple & Puja booking API client. Mirrors frontend/src/lib/puja.ts (the mobile app):
// browse a seeded catalog, book a puja, pay via Razorpay/wallet, get a booking slip.
// Money is server-authoritative: amount = per-person price × devotees (display only here).
import { api } from "./api";
