// Ask AstraVeda — voice consultation API client. Mirrors frontend/src/lib/consult.ts
// (the mobile app). The backend places an outbound phone call via Sarvam Voice
// Agents; money is server-authoritative (₹99/call — CONSULT_PRICE is display only).
import { api } from "./api";
