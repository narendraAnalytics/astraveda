// Palm Reading API client. Mirrors frontend/src/lib/palm.ts (the mobile app)
// — same backend, same ₹40 Razorpay contract, same server-authoritative
// reading. The optional palm photo never leaves the browser tab it was taken
// in — it isn't part of this payload, and the backend never stores it.
import { api } from "./api";
